        ...
        <React.Fragment>
            ...
            <Container className="resume-container">
                ...
                <ResumeSection title="TECHNICAL SKILLS" className="resume-section">
                    ...
                    <p className="resume-section-paragraph" ><span className="indented-title">Fluent:</span><span id="fluent" >C#.</span></p>
                    <p className="resume-section-paragraph" ><span className="indented-title">Others:</span><span id="others" >HTML, CSS, C, C++, Java, JavaScript.</span></p>
                    ...
                    <p className="resume-section-title" >Operating Systems:<span id="operating-systems" >Windows, Linux</span></p>
                </ResumeSection>
                <ResumeSection title="EDUCATION" className="resume-section">
                    <p className="resume-section-title" >Arizona State University<span id="asu-date">08/18 - 05/22</span></p>
                    <p className="resume-section-paragraph" >BS Software Engineering</p>
                    <p className="resume-section-paragraph" >GPA: 3.85</p>
                    <br />
